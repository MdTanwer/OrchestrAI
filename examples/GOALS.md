...
| **G3 Observability** | `08`, `11` expose tokens/cost; all production namespaces use `labels` |
...
| Shared context | `07` |
| Triggers (REST / webhook / cron) | `04`, `10`, `11` |
...
| Audience | Examples |
|----------|----------|
| **AI engineers** | `09` RAG support, `07` interview coach, `02` intel briefing |
| **Backend developers** | `04` ticket router, `12` contract review, `01` API-backed Q&A |
| **DevOps / platform** | `10` incident triage, `11` weekly digest, `05` resilient extraction |
